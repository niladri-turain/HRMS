...
import '../../model/employee_client_visit_list_model.dart';
...
class _ClientVisitScreenState extends State<ClientVisitScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<EmployeeClientVisitListProvider>().fetchClientVisits(status: _selectedStatus);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Consumer<EmployeeClientVisitListProvider>(
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      const Icon(Icons.calendar_today_outlined, size: 14, color: AppColors.black),
                                      const SizedBox(width: 6),
                                      Text(
                                        provider.visitListModel?.data?.date ?? Timing.getCurrentDate(),
                            ...
                            child: SizedBox(
                              ...
                              child: TextField(
                                onChanged: (value) {
                                  ...
                                  provider.fetchClientVisits(status: _selectedStatus, search: value);
                                },
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      provider.fetchClientVisits(status: 'upcoming');
                                    },
                                    child: Container(
                                      height: 40,
                                      decoration: BoxDecoration(
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      provider.fetchClientVisits(status: 'completed');
                                    },
                                    child: Container(
                                      height: 40,
                                      decoration: BoxDecoration(
